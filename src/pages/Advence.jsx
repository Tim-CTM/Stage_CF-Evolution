...
const imagesData = {
  bp: [
    ...
    { src: images.GA_SBPG, frontSrc: images.GA_FBPG, backSrc: images.GA_BBPG, className: "bp-base bp-Glass", price: null, color: "G" },
  ],
  coque: [
    { src: images.GA_SCoque0, frontSrc: images.GA_FCoque0,  className: "bp-base bp-GrisDMG", price: null, color: "DMG" },
    ...
    { src: images.GA_SCoqueCyanG, frontSrc: images.GA_FCoqueCyanG,  className: "bp-base bp-CyanG", price: null, color: "Cyan transparent" },
    { src: images.GA_SCoqueCyan, frontSrc: images.GA_FCoqueCyan,  className: "bp-base bp-Cyan", price: null, color: "Cyan" },
    { src: images.GA_SCoqueGreenG, frontSrc: images.GA_FCoqueGreenG, className: "bp-base bp-GreenG", price: null, color: "Vert transparent" },
    { src: images.GA_SCoqueOrangeG, frontSrc: images.GA_FCoqueOrangeG,  className: "bp-base bp-OrangeG", price: null, color: "Orange transparent" },
    { src: images.GA_SCoquePurpleG, frontSrc: images.GA_FCoquePurpleG,  className: "bp-base bp-PurpleG", price: null, color: "Violet transparent" },
    { src: images.GA_SCoqueRedG, frontSrc: images.GA_FCoqueRedG, className: "bp-base bp-RedG", price: null, color: "Rouge transparent" },
    ...
    { src: images.GA_SCoqueYellow, frontSrc: images.GA_FCoqueYellow,  className: "bp-base bp-Yellow", price: null, color: "Jaune" },
    { src: images.GA_SCoqueG, frontSrc: images.GA_FCoqueG,  className: "bp-base bp-G", price: null, color: "G" },
  ],
  baseconsole: [
  ...
  installation: [
    { src: null, frontSrc: null, className: "bp-base ", price: 29.99, color: "Blanc" },
    { src: null, frontSrc: null, className: "bp-base ", price: 40, color: "Noir" },
  ],
  backcoque: [
    { src: images.GA_SBCoque0, backSrc: images.GA_BCoque0, className: "bp-base bp-GrisDMG", price: null, color: "DMG" },
    { src: images.GA_SBCoqueBlackG, backSrc: images.GA_BCoqueBlackG, className: "bp-base bp-BlackGlass", price: 10, color: "Noir transparent" },
    { src: images.GA_SBCoqueBleuG, backSrc: images.GA_BCoqueBleuG, className: "bp-base bp-BleuG", price: null, color: "Bleu transparent" },
    { src: images.GA_SBCoqueCyanG, backSrc: images.GA_BCoqueCyanG, className: "bp-base bp-CyanG", price: null, color: "Cyan transparent" },
    { src: images.GA_SBCoqueCyan, backSrc: images.GA_BCoqueCyan, className: "bp-base bp-Cyan", price: null, color: "Cyan" },
    { src: images.GA_SBCoqueGreenG, backSrc: images.GA_BCoqueGreenG,  className: "bp-base bp-GreenG", price: null, color: "Vert transparent" },
    { src: images.GA_SBCoqueOrangeG, backSrc: images.GA_BCoqueOrangeG, className: "bp-base bp-OrangeG", price: null, color: "Orange transparent" },
    { src: images.GA_SBCoquePurpleG, backSrc: images.GA_BCoquePurpleG, className: "bp-base bp-Violet", price: null, color: "Violet " },
    { src: images.GA_SBCoqueRedG, backSrc: images.GA_BCoqueRedG,  className: "bp-base bp-PurpleG", price: null, color: "Rouge transparent" },
    { src: images.GA_SBCoqueRose, backSrc: images.GA_BCoqueRose, className: "bp-base bp-Rose", price: null, color: "Rose" },
    { src: images.GA_SBCoqueWhite, backSrc: images.GA_BCoqueWhite, className: "bp-base bp-White", price: null, color: "Blanc" },
    { src: images.GA_SBCoqueYellow, backSrc: images.GA_BCoqueYellow, className: "bp-base bp-Jaune", price: null, color: "Jaune" },
    { src: images.GA_SBCoqueG, backSrc: images.GA_BCoqueG, className: "bp-base bp-G", price: null, color: "G" },
  ],
  screen: [
  ...
  laniere: [
    ...
    { src: images.GA_SStrapRoseC, frontSrc: images.GA_FStrapRoseC, backSrc: images.GA_BStrapRoseC, className: "bp-base bp-RoseG", price: null, color: "Rose clair" },
 ...
 const ImageAll = () => {
  ...
  const calculateAllPrice = () => {
    const { bp, coque, baseconsole, pads, backcoque, laniere, installation } = selectImages;
    return basePrice + (bp.price ?? 0) + (coque.price ?? 0) + (baseconsole.price ?? 0) + (pads.price ??0) + (backcoque.price ?? 0) + (laniere.price ?? 0) + (installation.price?? 0);
  };
